...
def lists_products():
    ...
    if request.args.get("name"):
        app.logger.info("Request to Retrieve all products by name.")
        name = request.args.get("name")
        products = Product.find_by_name(name)

    elif request.args.get("category"):
        app.logger.info("Request to Retrieve all products by category.")
        category = request.args.get("category")
        category_value = getattr(Category, category.upper())
        products = Product.find_by_category(category_value)

    elif request.args.get("available"):
        app.logger.info("Request to Retrieve all products by availability.")
